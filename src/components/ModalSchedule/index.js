        ...
        <ul onClick={props.onClose}>
          <li>
            {pathname === '/estudios/sala01'
              ? <Link to="marcar" smooth onClick={props.onClose} className="text-blue"><div><span>ensaiar na</span>SALA AZUL</div></Link>
              : <NavLink to="/estudios/sala01#marcar" className="text-blue">
                <div><span>ensaiar na</span>SALA AZUL</div></NavLink>
            }
          </li>
          <li>
            {pathname === '/estudios/sala02'
              ? <Link to="marcar" smooth offset={5} onClick={props.onClose} className="text-red"><div><span>ensaiar na</span>SALA VERMELHA
              </div></Link>
              : <NavLink to="/estudios/sala02#marcar" className="text-red">
                <div>
                  <span>ensaiar na</span>SALA VERMELHA
                </div>
              </NavLink>
            }
          </li>
          <li>
            ...
            {pathname === '/gravacao'
              ? <Link to="gravar" offset={5} smooth onClick={props.onClose} className="text-pink"><div>
